(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(400, 500, 1, 1, true);
        platform.create(250, 550, 1, 1, true);
        platform.create(500, 300, 1, 1, true);
        platform.create(250, 400, 1, 1, true);
        platform.create(1, 600, 3, 1, true);
